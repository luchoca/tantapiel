...
function App(){
  ...
  return <div className="site">
    ...
    <header className="header">
      <button className="brand" onClick={()=>window.scrollTo({top:0,behavior:'smooth'})}><img src="/images/logotantapiel.png" alt="Tanta Piel" style={{width:'300px', maxWidth:'42vw', height:'auto', display:'block'}} /></button>
