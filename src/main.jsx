...
const whatsapp = 'https://api.whatsapp.com/send?phone=59891099242&text=Hola%2C%20quisiera%20consultar%20por%20un%20tratamiento%20en%20Tanta%20Piel.';
const instagram = 'https://www.instagram.com/tantapiel';
...
const defaultContent = {
  ...
  location: { eyebrow: 'Encontranos / 05', title: 'Hacé lugar', emphasis: 'para vos.', address: 'Av. España 2145, Montevideo (provisoria)', hours: 'Lunes a viernes, con agenda previa', whatsapp: '+598 91 099 242' },
...
function App(){
  ...
  return <div className="site">
    ...
    <main>
      ...
      <section id="location" className="location section-pad reveal"><div className="eyebrow">{content.location.eyebrow}</div><div className="location-grid"><h2>{content.location.title}<br/><em>{content.location.emphasis}</em></h2><div className="location-data"><p><strong>Dirección 1</strong><br/>Paysandú, Uruguay</p><p><strong>Dirección 2</strong><br/>Montevideo, Uruguay (agendar cita)</p><p><strong>Horarios</strong><br/>{content.location.hours}</p><p><strong>WhatsApp</strong><br/>{content.location.whatsapp}</p><a className="text-link" style={{textDecoration:'none', borderBottom:'none'}} href="https://maps.google.com/?q=Paysand%C3%BA,Uruguay" target="_blank" rel="noreferrer">Cómo llegar</a></div></div><div className="location-map"><iframe title="Mapa de Tanta Piel" src="https://www.google.com/maps?q=Paysand%C3%BA%2C%20Uruguay&z=12&output=embed" loading="lazy" referrerPolicy="no-referrer-when-downgrade" /></div></section>
    ...
    <footer className="footer"><div><strong>Tanta Piel</strong><span>Cosmetología &amp; skincare</span></div><nav><button onClick={()=>go('about')}>Sobre Tanta Piel</button><button onClick={()=>go('treatments')}>Tratamientos</button><button onClick={()=>go('contact')}>Contacto</button></nav><div className="footer-social"><a href={instagram} target="_blank" rel="noreferrer">Instagram</a><a href={whatsapp}>WhatsApp</a></div><a className="admin-link" href="/admin/" aria-label="Abrir administración" title="Administración"><svg viewBox="0 0 24 24" aria-hidden="true"><path d="M12 8.5a3.5 3.5 0 1 0 0 7 3.5 3.5 0 0 0 0-7Zm8.1 3.5a6.9 6.9 0 0 0-.1-1l2-1.5-2-3.4-2.4 1a7.5 7.5 0 0 0-1.7-1L15.6 3h-3.9l-.3 2.8a7.5 7.5 0 0 0-1.7 1l-2.4-1-2 3.4 2 1.5a6.9 6.9 0 0 0-.1 1c0 .3 0 .7.1 1l-2 1.5 2 3.4 2.4-1a7.5 7.5 0 0 0 1.7 1l.3 2.8h3.9l.3-2.8a7.5 7.5 0 0 0 1.7-1l2.4 1 2-3.4-2-1.5c.1-.3.1-.7.1-1Z"/></svg></a><small>© {new Date().getFullYear()} Tanta Piel</small></footer>
  </div>
}
